...
char addr;
  ...
  I2C1_Start();                        // Start I2C2 module
  I2C1_Write(WM8731_ADDRESS);          // Write Adress of WM8731 chip
  I2C1_Write(addr);                    // Write register address
  I2C1_Write(lo(cmd));                 // Write command
  I2C1_Stop();                         // Stop I2C2 module
}
...
void WM8731_Init(){
  ...
  I2C1_init(100000);                          // Init I2C2 module (100Khz)
  delay_ms(100);
...
//  WM8731_CMD(WM8731_Reg_Active_ctrl, _WM8731_Activete);      // Activate module
